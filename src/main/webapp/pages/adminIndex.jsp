...
<table style="float: right">
    ...
    <form method="POST" action="timetracking">
        <tr><td><fmt:message key="adminIndex.firstName"/></td><td><input type="text" name="firstName" /></td></tr>
        <tr><td><fmt:message key="adminIndex.lastName"/></td><td><input type="text" name="lastName" /></td></tr>
        <tr><td>E-mail</td><td><input type="text" name="email" /></td></tr>
        <tr><td><fmt:message key="index.password"/></td><td><input type="text" name="pass" /></td></tr>
        <tr><td><fmt:message key="adminIndex.role"/></td><td><input type="text" name="role" /></td></tr>
